package uz.ilhomjon.a3dxurshidakauchun.model3D.demo;
...
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.objects.Cube;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.services.LoadListener;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.services.LoadListenerAdapter;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.services.LoaderTask;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.services.collada.ColladaLoader;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.services.wavefront.WavefrontLoader;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.util.Exploder;
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.util.Rescaler;
    ...
    protected List<Object3DData> build() throws Exception {
        ...
        try {
            ...
            try {
                ...
                }).load(new URI("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/assets/models/teapot.obj")).get(0);
            ...
            try {
                ...
                }).load(new URI("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/assets/models/cube.obj")).get(0);
            ...
            try {
                ...
                }).load(new URI("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/assets/models/ToyPlane.obj")).get(0);
            ...
            try {
                // this has heterogeneous faces
                Object3DData obj53 = new ColladaLoader().load(new URI("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/assets/models/cowboy.dae"), new LoadListenerAdapter(){
                    @Override
                    public void onLoad(Object3DData obj53) {
