...
import uz.ilhomjon.a3dxurshidakauchun.android_3d_model_engine.model.CubeMap;
...
public class SkyBox {
    ...
    public static SkyBox getSkyBox2() {
        try {
            return new SkyBox(new URI[]{
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/posx.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/negx.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/posy.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/negy.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/posz.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/negz.png")});
        } catch (IOException e) {
    ...
    public static SkyBox getSkyBox1() {
        try {
            return new SkyBox(new URI[]{
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/right.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/left.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/top.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/bottom.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/front.png"),
                    URI.create("android://uz.ilhomjon.a3dxurshidakauchun.dddmodel2/res/drawable/back.png")});
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
